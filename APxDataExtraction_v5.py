...
class APxAutomation:
    ...
    def append_or_export_to_excel(self, checked_signal_paths, unit_descriptor=None, filename=None, args=None):
        ...
        if os.path.exists(file_name):
            # File exists, open the workbook and append data
            self.append_to_existing_excel(file_name, checked_signal_paths, unit_descriptor)  # Pass the file_name instead of the workbook object
            logging.info(f"Appended data to {file_name}.")
        else:
            # File does not exist, create new workbook and export data
